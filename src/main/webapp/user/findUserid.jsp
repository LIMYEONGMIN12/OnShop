...
function fn_findUserid() {
	...
	var url = "findUseridSub.do?userName="+userName+"&userEmail="+userEmail;
		   ...
		   <div class="div2">
			...
			<table style="border:0;margin:0 auto;margin-top:15px;margin-bottom:15px; ">
				<tr>					
					...
					<td style="text-align:center;"> <input type ="text" name="userName" class="input_login" autofocus placeholder="이름"/> </td>
				</tr>
				<tr>	
								
					<td style="text-align:center"><input type ="text" name="userEmail" class="input_login" placeholder="이메일"> </td>					
				</tr>
				<tr>
				<td colspan="2">
					<button type="button" class="button_login" onclick="fn_findUserid();">아이디 찾기</button>
	             <!--  
