...
function fn_allcheck() {
    ...
    var len = document.frm.ag1.length;
 
    var result = document.frm.allcheck.checked;
 
    if (document.frm.allcheck.checked == result){
        for(var i=0;i<len;i++){
            document.frm.ag1[i].checked=result;
    	}
    }
}
function fn_submit(){
    ...
    for (var i =0;i<len ;i++ )    {
        if(document.frm.ag1[i].checked==false) chk=1;
...
<section>
        ...
        <article>
    <form name="frm" id="frm" method="post" action="ShoppingUserWrite.do">
            <input type ="hidden" id="idcheck" name="idcheck" value="N">
            <div class="div1">
					회원가입 약관
			</div>
            
            <p style="text-align:center;color:red;font-size:12px;">회원가입약관 및 개인정보처리방침안내의 내용에 동의하셔야 회원가입 하실 수 있습니다.</p>
          
          
           <table class= "table1" align="center" style="background:#FBFAFA;">
           <tr >
           ...
           <tr>
         	<td class="td2" style="text-align:left;padding-left:40px;">
         	<input type="checkbox" name="allcheck" onclick ="fn_allcheck()">
           ...
           <tr>
	           <td class="td2">
	           <h3 style="font-size:15px;padding-top:5px;align:left;text-align:left;padding-left:40px;">
	           [필수] 이용약관 동의</h3>
           <textarea readonly class="textarea1">
      제1조(목적)
이 약관은 캐나다 세레나마켓 회사(전자상거래 사업자)가 운영하는 캐나다 세레나마켓 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리.의무 및 책임사항을 규정함을 목적으로 합니다.
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」

제2조(정의)
① “몰”이란 캐나다 세레나마켓 회사가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
부 칙(시행일) 이 약관은 년 월 일부터 시행합니다.
          ...
          <br>
       	 <span style="float:right;padding-right:40px;padding-top:5px;font-size:12px;">
       	  회원가입약관의 내용에 동의합니다  <input type="checkbox" name="ag1" value="1"> </span>
            ...
            <td class="td2">
            <h3 style="font-size:15px;padding-top:5px;text-align:left;text-align:left;padding-left:40px;">
            [필수] 개인정보 수집 및 이용 동의</h3>
         <textarea class="textarea1" readonly>
        1. 개인정보 수집목적 및 이용목적
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.
         ...
         <br>
          <span style="float:right;padding-right:40px;padding-top:5px;font-size:12px;"> 개인정보 수집 및 이용에 동의합니다. <input type="checkbox" name="ag1" value="1"> </span>
            ...
            <div style="margin-top:12px;">
             <input type="submit" value="회원가입"   class="button2" onclick="fn_submit();return false;">
