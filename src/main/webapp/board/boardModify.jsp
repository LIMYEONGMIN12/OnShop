					...
					<table class="board_table" style="width:1000px;">
						...
						<tr>
							...
							<td class="board_td" style="border-right:0px;"> 
								<input type="text" id="title" name="title" class="board_input"  value="${vo.title }" style="height:30px;" autofocus>
							</td>
						</tr>
						...
						<tr>
							...
							<td class="board_td" style="border-right:0px;">
								<textarea name="content"  id="content" class="board_write_content" rows="10" cols="80">${vo.content}</textarea> 
							</td>
						</tr>
					</table>
					<div class="btn_box" >
