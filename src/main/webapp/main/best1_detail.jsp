...
<body>
    ...
    <section class="detail_section">
        <div class="detail_main_image">
            <img src="../images/img2/best1large.jpg" />
        </div>
                    ...
                    <div class="box_in_box">
                        <div class="points_tip">
                            ...
                            <div class="naver_points">
                                <div class="img1">
                                    <img src="../images/img2/naver_member.png" alt=""><span style="font-size: 7px;"><u>최대 5% 적립, 무료 시작 ></u></span>
                                ...
                                <div class="img3">
                                    <img src="../images/img2/naver_points.png" alt=""><span style="font-size: 7px;"><u>최대 5% 적립, 무료 시작 ></u></span>
                ...
                <div class="txt">
                    <select name="op1" onchange="GoodsProc.set_opt2();" style='width: 100%;' data-goods_idx="126073" class="view_select_box">
                        <option value="">--필수 선택</option>
                            <option data-opname="니트 스웨터(베이지) : Free" data-ispluslimit="0" class="todayDeliv" value="">니트 스웨터(베이지) : Free</option>
                            <option data-opname="니트 스웨터(그레이) : Free" data-ispluslimit="0" class="todayDeliv" value="">니트 스웨터(그레이) : Free</option>
                            <option data-opname="니트 스웨터(인디블루) : Free" data-ispluslimit="0" class="todayDeliv" value="">니트 스웨터(인디블루) : Free</option>
                    </select>
            </div>
    ...
    <section>
        ...
        <div class="detail_info_detail">
            <img src="../images/img2/detailCollage.jpg" alt="">
            <img src="../images/img2/color.png" alt="">
        </div>
    </section>
    ...
    <section style="margin-bottom:50px;">
        ...
        <div class="shopping_guide" >
            <div class="delivery_guide" >
                <div class="guide_info" style="margin-left:50px;">배송안내</div>
            </div>
            <div class="inner">
                <div>
            ...
            <div class="exchange_guide">
                <div class="guide_info" style="margin-left:50px;">교환&반품안내</div>
            </div>
            <div class="inner">
                <div>
                ...
                - 교환&반품 배송비 <b>입금계좌 : OO은행 1111-222-3333 / 예금주 (주)MARKET</b>
                 ...
                 <div class="inner" style="margin-left:50px;margin-bottom:50px;">
               <div class="guide_info">[교환반품 불가항목]</div>
                반품시일이 지난 경우<br>
