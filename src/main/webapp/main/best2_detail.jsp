...
<link rel="stylesheet" href="../static/css/best2_detail.css">
...
<body>
    ...
    <section class="detail_section">
        <div class="detail_main_image">
            <img src="../static/img2/best2large.jpg" />
        </div>
        <div class="detail_info">
            <h3>
                <img src="../static/img2/custom1.gif" alt="">
                <img src="../static/img2/custom4.gif" alt="">
                ...
                <div class="txt">
                    <select name="op1" onchange="GoodsProc.set_opt2();" style='width: 100%;' data-goods_idx="126073" class="view_select_box">
                        <option value="">--필수 선택</option>
                            <option data-opname="기본 티셔츠(블랙) : S" data-ispluslimit="0" class="todayDeliv" value="">기본 티셔츠(블랙) : S</option>
                            <option data-opname="기본 티셔츠(블랙) : M" data-ispluslimit="0" class="todayDeliv" value="">기본 티셔츠(블랙) : M</option>
                            <option data-opname="기본 티셔츠(블랙) : L" data-ispluslimit="0" class="todayDeliv" value="">기본 티셔츠(블랙) : L</option>
                            <option data-opname="기본 티셔츠(블랙) : XL" data-ispluslimit="0" class="todayDeliv" value="">기본 티셔츠(블랙) : XL</option>
                            <option data-opname="기본 티셔츠(화이트) : S" data-ispluslimit="0" class="todayDeliv" value="">기본 티셔츠(화이트) : S</option>
                            <option data-opname="기본 티셔츠(화이트) : M" data-ispluslimit="0" class="todayDeliv" value="">기본 티셔츠(화이트) : M</option>
                            <option data-opname="기본 티셔츠(화이트) : L" data-ispluslimit="0" class="todayDeliv" value="">기본 티셔츠(화이트) : L</option>
                            <option data-opname="기본 티셔츠(화이트) : XL" data-ispluslimit="0" class="todayDeliv" value="">기본 티셔츠(화이트) : XL</option>
                    </select>
            </div>
    ...
    <section>
        ...
        <div class="detail_info_detail">
            <img src="../static/img2/detailCollage2.jpg" alt="">
            <img src="../static/img2/color2.png" alt="">
        </div>
    </section>
