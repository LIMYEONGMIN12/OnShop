...
<link rel="stylesheet" href="../static/css/best3_detail.css">
<title>Jeans - MARKET</title>
...
<body>
    ...
    <section class="detail_section">
        <div class="detail_main_image">
            <img src="../static/img2/best3large.jpg" />
        </div>
                ...
                <div class="txt">
                    <select name="op1" onchange="GoodsProc.set_opt2();" style='width: 100%;' data-goods_idx="126073" class="view_select_box">
                        <option value="">--필수 선택</option>
                            <option data-opname="청바지 : S" data-ispluslimit="0" class="todayDeliv" value="">청바지 : S</option>
                            <option data-opname="청바지 : M" data-ispluslimit="0" class="todayDeliv" value="">청바지 : M</option>
                            <option data-opname="청바지 : L" data-ispluslimit="0" class="todayDeliv" value="">청바지 : L</option>
                            <option data-opname="청바지 : XL" data-ispluslimit="0" class="todayDeliv" value="">청바지 : XL</option>
                    </select>
            </div>
    ...
    <section>
        ...
        <div class="detail_info_detail">
            <img src="../static/img2/detailCollage3.jpg" alt="">
        </div>
    </section>
