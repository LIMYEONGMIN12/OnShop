...
public class EgovSampleController {
	...
	@RequestMapping(value = "shopping_index.do")
	...
	public String selectSampleList(@ModelAttribute("searchVO") SampleDefaultVO searchVO, ModelMap model) throws Exception {
		...
		searchVO.setPageUnit(propertiesService.getInt("pageUnit")); // 한 화면의 데이터 출력 개수
		searchVO.setPageSize(propertiesService.getInt("pageSize")); // 한 화면의 페이징 나열 개수
